@echo off
rem ===========================================================================
rem  Mriya - build Mriya.scr for 64-bit Windows and install it
rem
...
set "OUT=%ROOT%build\%PRESET%\Mriya.scr"
if not exist "%OUT%" (
...
call :sha256 "%OUT%"
echo.
echo  Built: build\%PRESET%\Mriya.scr
...
if not defined INSTALL (
    echo.
    echo  Try it in a window:   build\%PRESET%\Mriya.scr /w
...
set "SCANLOG=%TEMP%\mriya-defender-scan.txt"
